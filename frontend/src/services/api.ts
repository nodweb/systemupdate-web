...
export const api = createApi({
  ...
  endpoints: (build: any) => ({
    ...
    getCommands: build.query<Array<{ id: string; device_id: string; name: string; created_at: string; status: string }>, void>({
...
export const { useGetHealthQuery, useGetIngestHealthQuery, useGetAnalyticsHealthQuery, useGetExampleCommandsQuery, useGetCommandsQuery, useCreateCommandMutation, usePostIngestMutation } = api
